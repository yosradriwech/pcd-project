...
public class NorthGetSubUnsubStatusLogger extends AbstractLogger {

	private final static Logger LOGGER = LoggerFactory.getLogger(NORTH_GET_STATUS_LOGGER);
	...
	public void write(LogFields logFields) {
		...
		message.append(PdkLogUtils.LOG_FIELD_SEPARATOR);
		message.append(PdkLogUtils.formatValue(logFields.getCreationDate()));
		message.append(PdkLogUtils.LOG_FIELD_SEPARATOR);

		message.append(PdkLogUtils.formatValue(logFields.getTransactionId()));
		message.append(PdkLogUtils.LOG_FIELD_SEPARATOR);
		...
		message.append(PdkLogUtils.LOG_FIELD_SEPARATOR);
		message.append(PdkLogUtils.formatValue(logFields.getStatus()));
		message.append(PdkLogUtils.LOG_FIELD_SEPARATOR);
